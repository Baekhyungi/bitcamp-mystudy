...
public class Exam0120 {
  ...
  public static void main(String[] args) throws Exception {
    //    Class.forName("study.reflect.ex01.B");
    // => 바깥 클래스가 로딩되었다고 중첩 클래스가 자동으로 로딩되는 것은 아니다.

    Class.forName("study.reflect.ex01.B$C");
    ...
    //    study.reflect.ex01.B.C obj;
    //    obj = new study.reflect.ex01.B.C();
